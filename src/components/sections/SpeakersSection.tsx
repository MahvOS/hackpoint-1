...
export default function SpeakersSection() {
    ...
    >
      ...
      {speaker.speakerImage && (
        <div className="absolute left-[16px] sm:left-[20px] md:left-[24px] top-[30px] sm:top-[42px] md:top-[54px] w-[240px] sm:w-[290px] md:w-[342px] h-[260px] sm:h-[315px] md:h-[369px]">
          <img src={speaker.speakerImage} alt="" className="w-full h-full object-cover" style={maskStyle} />
        </div>
      )}
      ...
      <div className="absolute left-[16px] sm:left-[20px] md:left-[24px] bottom-[16px] sm:bottom-[18px] md:bottom-[20px] w-[140px] sm:w-[160px] md:w-[186px] flex flex-col gap-[6px] sm:gap-[8px] capitalize">
        <p className="text-[12px] sm:text-[14px] md:text-[18px] font-medium text-white/80 leading-tight" style={{ fontWeight: 510 }}>
          {speaker.title}
        </p>
  ...
  return (
    <section className="relative px-4 sm:px-6 md:px-[70px] overflow-hidden min-h-screen py-8 sm:py-12 md:py-16" style={{ backgroundColor: '#1A1A1A' }}>
      ...
      >
        <h2
          ...
          style={{
            ...
            fontWeight: 500,
            lineHeight: 0.8,
            background: 'linear-gradient(91deg, rgba(255, 255, 255, 0.00) -68.13%, #FFF 15.66%, rgba(255, 255, 255, 0.00) 99.45%)',
            backgroundClip: 'text',
