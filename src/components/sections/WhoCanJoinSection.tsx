...
const targetAudiences = [
  ...
  {
    description:
      'Komunitas, organisasi, atau perusahaan yang ingin berkolaborasi di bidang keamanan digital.',
  ...
  return (
    <section className="relative bg-[#1A1A1A] py-8 md:py-32 px-2 sm:px-4 md:px-[70px] overflow-hidden min-h-[100vh] md:min-h-[150vh] w-full">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to top, rgba(211, 53, 51, 0.8) 0%, rgba(211, 53, 51, 0.5) 25%, rgba(211, 53, 51, 0.2) 35%, transparent 50%)',
        }}
      />
      ...
      <div className="block md:hidden relative z-40 w-full max-w-[337px] mx-auto text-left px-1">
        ...
        >
          ...
          >
            HackPoint terbuka untuk siapa saja yang punya ketertarikan di dunia teknologi dan
            keamanan siber.
          </p>
        </motion.div>
      </div>
        ...
        <div className="absolute bottom-0 left-1/2 w-[1500px] h-[750px] transform -translate-x-1/2 translate-y-1/2 -translate-y-[250px] z-10">
          <div
            ...
            style={{
              ...
              boxShadow:
                '0 60px 120px -30px rgba(0, 0, 0, 0.9), 0 0 150px rgba(211, 53, 51, 0.4), 0 0 200px rgba(0, 0, 0, 0.5)',
            }}
          >
            {/* Noise Texture Layer */}
            <div
        ...
        <div className="absolute bottom-0 left-1/2 w-[1250px] h-[625px] transform -translate-x-1/2 translate-y-1/2 -translate-y-[150px] z-20">
          <div
            ...
            style={{
              backgroundColor: '#d33533',
              boxShadow:
                '0 50px 100px -25px rgba(0, 0, 0, 0.85), 0 0 120px rgba(211, 53, 51, 0.35), 0 0 160px rgba(0, 0, 0, 0.4)',
            }}
          >
            {/* Noise Texture Layer */}
            <div
        ...
        <div className="absolute bottom-0 left-1/2 w-[1100px] h-[550px] transform -translate-x-1/2 translate-y-1/2 -translate-y-[50px] z-30">
          <div
            ...
            style={{
              backgroundColor: '#d33533',
              boxShadow:
                '0 40px 80px -20px rgba(0, 0, 0, 0.8), 0 0 100px rgba(211, 53, 51, 0.3), 0 0 120px rgba(0, 0, 0, 0.35)',
            }}
          >
            {/* Noise Texture Layer */}
            <div
